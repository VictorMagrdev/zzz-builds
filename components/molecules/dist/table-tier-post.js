...
function TableTierPost() {
    ...
    //   }, 2000);
    // }, [])
    return (React.createElement("div", { className: "grid grid-col-1 gap-8 space-y-4 " + tokens_1.bg_blue_30 + " rounded-lg mx-auto max-h-lvh max-w-screen-lg my-auto" },
        React.createElement("div", { className: 'p-4' },
            React.createElement("div", { className: "grid grid-flow-col grid-cols-2 gap-8 border border-y-indigo-50 border-x-transparent " },
                React.createElement("div", { className: 'place-items-start py-4' },
